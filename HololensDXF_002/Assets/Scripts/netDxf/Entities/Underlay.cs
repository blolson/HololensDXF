...
namespace netDxf.Entities
{
        ...
        EntityObject
    {
        ...
        public short Contrast
        {
            ...
            set
            {
                if (value < 20 || value > 100)
                    throw new ArgumentOutOfRangeException("nameof", value, "Accepted contrast values range from 20 to 100.");
                this.contrast = value;
            }
        }
        ...
        public short Fade
        {
            ...
            {
                if (value < 0 || value > 80)
                    throw new ArgumentOutOfRangeException("nameof", value, "Accepted fade values range from 0 to 80.");
                this.fade = value;
            }
        }
