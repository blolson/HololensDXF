...
public class Fitbox : MonoBehaviour
{
    ...
    [Tooltip("The SceneStateManager to progress when the Fitbox is dismissed.")]
    public SceneStateManager SSM;
    ...
    public void VoiceDismissFitBox()
    {
        DismissFitbox();
    }
    ...
    private void DismissFitbox()
    {
        ...
        {
            if(SSM.currentState == SceneStateManager.SceneStates.Start)
                SSM.Progress();
        }
    ...
    private void LateUpdate()
    {
        ...
        if (gameObject.activeInHierarchy)
        {
            ...
            {
                //var render = lineRenderer.material;
                ...
                {
                    var render = trailRenderers[i].material;
                    var color = render.color;
